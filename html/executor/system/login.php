...
<div id="main">
	...
	<div id="tray" class="box">
		...
		<p class="f-left box">
			...
			Project: <strong><?php echo escapeHtml(SITE_NAME) ?> 管理画面</strong>
...
<table>
  ...
  <tr>
  	<td colspan="2" align="center">
		...
		<input type="hidden" name="<?php echo file_get_contents(WEB_APP.'config/secret.php') ?>" value="" />
	</td>
  </tr>
</table>
</form>
