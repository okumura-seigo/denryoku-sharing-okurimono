    ...
    <main class="l-contents">
      ...
      <section class="l-contents__section">
        <div class="l-contents__inner">
          <h2 class="c-title__page">お問い合わせ完了</h2>
          <p>お問い合わせいただき、ありがとうございました。内容を確認させていただき、後ほど担当者よりご回答いたします。恐れ入りますが、今しばらくお待ちくださいますようお願い申し上げます。</p>
        </div>
        <a href="<?php echo h(HOME_URL) ?>mypage/" style="color: white;"><button class="c-form__button" type="submit">マイページに戻る</button></a>
      </section>
    </main>
