        ...
        <div class="l-contents__inner">
          ...
          <div class="p-mypage__wrap">
            <div class="p-mypage__prof">
              ...
              <h3 class="p-mypage__point-title">現在の保有ポイント</h3>
...
<?php if(count($my_page_datas['disp_messages']) == 0){  ?>
              <div class="c-announce">
                <h4 class="c-announce__title">アナウンス</h3>
                <a class="c-announce__edit">編集</a>
                <!-- <p class="c-announce__text">アナウンスはありません。ここでは従業員に対してのお知らせや、共有事項などを表示できます。</p> -->
                <p class="c-announce__text">現在、お知らせはありません。</p>
...
<?php if(count($my_page_datas['disp_project']) == 0){  ?>
              <div class="c-announce">
                <h4 class="c-announce__title">アナウンス</h3>
                <a class="c-announce__edit">編集</a>
                <!-- <p class="c-announce__text">アナウンスはありません。ここでは従業員に対してのお知らせや、共有事項などを表示できます。</p> -->
                <p class="c-announce__text">参加プロジェクトはありません。</p>
              </div>
<?php } else { ?>              
              <dl class="c-list">
