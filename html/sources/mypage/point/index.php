...
<?php foreach ($resPointDetail as $key => $val) { ?>
                <tr>
                  <td class="u-center" style="width:20%;"><?php echo h(substr($val['insert_datetime'], 0, -9)) ?></td>
                  <td><?php echo h($val['point_division_atext']) ?></td>
...
<?php } ?>
          ...
          <div class="c-pagination__wrap">
            <ul class="c-pagination">
              ...
              <li><a href="#">2</a></li> -->
              <?php
                $max_count = ceil((int)$resPointDetail / 5);
