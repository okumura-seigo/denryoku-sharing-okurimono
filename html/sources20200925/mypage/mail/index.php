          ...
          <table class="c-table">
            ...
            ?>
                <tr class="border">
                  <td>
                    <p>
                      <span class="pr-3"><?php echo $val['recieved_date'] ?></span>
                      <?php echo $val['title'] ?>
                    </p>
                  </td>
                  <form name="friendForm<?php echo $key ?>" action="detail" method="post">
                    <input type="hidden" name="id" value="<?php echo $val['message_id'] ?>">
                  </form>
                  <td>
                    <button class="btn-primary" onClick="document.friendForm<?php echo $key ?>.submit();return false;">詳細</button>
                  </td>
                </tr>
            <?php }　?>
          </table>
