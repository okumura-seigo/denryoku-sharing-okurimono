        ...
        <div class="l-contents__inner">
          ...
          <table class="c-table">
            ...
            <!-- <tr>
              ...
              <td>会員登録</td>
              <td class="u-center">300</td>
            </tr>
            <tr>
              <td class="u-center">2020-07-01</td>
              <td>交換</td>
              <td class="u-center">-200</td>
            </tr> -->
            <?php
              foreach ($point_historys['point_history'] as $key => $val) {
            ?>
                <tr>
                  <td class="u-center"><?php echo $val['date'] ?></td>
                  <td><?php echo $val['point_division'] ?></td>
                  <td class="u-center"><?php echo $val['point'] ?></td>';
                </tr>
             <?php } ?>
          </table>
