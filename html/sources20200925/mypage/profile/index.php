          ...
          <form action="conf" class="c-form">
            <table class="c-form__table">
              ...
              <tr>
                <th>セイ</th>
                <td>
                  <input type="text" class="c-form__input" name="firi1" placeholder="セイ" value="<?php echo $user_datas['furi1'] ?>">
                </td>
                <th>メイ</th>
                <td>
                  <input type="text" class="c-form__input" name="firi2" placeholder="メイ" value="<?php echo $user_datas['furi2'] ?>">
                </td>
              </tr>
            </table>
            <table class="c-form__table">
                  ...
                  <div class="c-form__float">
                    <div class="c-form__float-item">
                      <div class="c-form__radio">
                        <input type="radio" id="radio1" name="sex" value="0" <?php if($user_datas['sex'] == '0') { echo 'checked="checked"'; } ?> >
                        <label for="radio1">男性</label>
                      </div>
                    </div>
                    <div class="c-form__float-item">
                      <div class="c-form__radio">
                        <input type="radio" id="radio2" name="sex" value="1" <?php if($user_datas['sex'] == '1') { echo 'checked="checked"'; } ?> >
                        <label for="radio2">女性</label>
                      </div>
                    </div>
                    <div class="c-form__float-item">
                      <div class="c-form__radio">
                        <input type="radio" id="radio3" name="sex" value="2" <?php if($user_datas['name'] == '2') { echo 'checked="checked"'; } ?> >
              ...
              <tr>
                ...
                <td>
                  <div class="c-form__float">
                    ...
                    <input type="text" class="c-form__input" name="birthday" value="<?php echo $user_datas['birthday'] ?>">
                  </div>
                </td>
              </tr>
              <tr>
