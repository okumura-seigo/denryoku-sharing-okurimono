      ...
      <section class="l-contents__section">
        <div class="l-contents__inner">
          ...
          <table class="c-table">
            ...
            <!-- <tr>
              <td class="u-center">2020-07-01</td>
              <td>長野塩尻グッドライフプロジェクト</td>
              <td class="u-center">進行中</td>
              <td class="u-center"><a href="detail.html">詳細</a></td>
            </tr>
            <tr>
              <td class="u-center">2020-07-01</td>
              <td>長野塩尻グッドライフプロジェクト</td>
              <td class="u-center">終了</td>
              <td class="u-center"><a href="detail.html">詳細</a></td>
            </tr>
            <tr>
              <td class="u-center">2020-07-01</td>
              <td>長野塩尻グッドライフプロジェクト</td>
              <td class="u-center">開始予定</td>
              <td class="u-center"><a href="detail.html">詳細</a></td>
            </tr> -->
            <?php
            ...
            ?>
              <tr>
                <td class="u-center"><?php echo $val['start_day'] ?></td>
                <td><?php echo $val['project_name'] ?></td>
                <td class="u-center"><?php echo $val['project_history_status'] ?></td>
              </tr>
            <?php
              }
            ?>
