                ...
                <td>
                  <select name="pref">
                    ...
                    <?php foreach ($PREFECTURE_CODE as $key => $val) { ?>
                      <option value="<?php echo h($key) ?>" <?php if ($pref == $key) echo "selected"; ?>><?php echo h($val) ?>
                      </option>
                    <?php } ?>
                  </select>
                </td>
                ...
                <td>
                  ...
                  <div class="u-mt1em u-center">
                    <div class="c-form__checkbox">
                      <input type="checkbox" id="checkbox1" name="checkbox" value="1" checked="<?php if ($checkbox == "1") echo "checked"; ?>">
