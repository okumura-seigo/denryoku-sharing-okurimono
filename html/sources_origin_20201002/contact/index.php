            ...
            <form action="send" method="POST" class="c-form">
              <table class="c-form__table">
                <tr>
                  <th>お名前</th>
                  <td>
                    <input type="text" class="c-form__input" name="name" placeholder="お名前" required>
                  </td>
                </tr>
                <tr>
                  <th>メールアドレス</th>
                  <td>
                    <input type="email" class="c-form__input" name="email" placeholder="メールアドレス" required>
                  </td>
                </tr>
                <tr>
                  <th>お問い合わせ件名</th>
                  <td>
                    <input type="text" class="c-form__input" name="title" placeholder="お問い合わせ件名" required>
                  </td>
                </tr>
                <tr>
                  <th>お問い合わせ内容</th>
                  <td>
                    <textarea name="loginid" class="c-form__textarea" placeholder="お問い合わせ内容" required></textarea>
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
