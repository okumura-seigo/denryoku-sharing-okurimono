        ...
        <div class="l-contents__inner">
          ...
          <table class="c-table">
            ...
            <tr>
              ...
              <td><?php echo h($infoMessage['insert_datetime']) ?></td>
            </tr>
            <tr>
              <th>内容</th>
...
<?php if ($infoMessage['file'.$i]) { ?>
                      <a href="<?php echo h(UPLOAD_FILE_URL.$infoMessage['file'.$i]) ?>" target="_blank"><img src="<?php echo h(UPLOAD_FILE_URL.$infoMessage['file'.$i]) ?>" style="width:40%;"></a>
                      <br>
<?php } ?>
<?php } ?>
              </td>
