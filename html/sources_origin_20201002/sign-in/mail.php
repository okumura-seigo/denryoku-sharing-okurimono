    ...
    <main class="l-contents">
      ...
      <section class="l-contents__section">
        <div class="l-contents__inner">
          <h2 class="c-title__page">ログイン出来ない場合のお手続き</h2>
...
<?php } ?>
          <div class="l-contents__item">
            <form action="mail_exe" method="POST" class="c-form">
              <table class="c-form__table">
                <tr>
                  <th class="u-w12em">メールアドレス</th>
                  <td>
                    <input type="text" class="c-form__input" name="loginid" placeholder="メールアドレス" value="<?php echo h($loginid) ?>" >
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
                    <button class="c-form__button" type="submit">次に進む</button>
                  </td>
                </tr>
              </table>
            </form>
