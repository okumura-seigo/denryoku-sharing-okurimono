...
// データ
$whereArray = array();
if (isset($_REQUEST['project_id']) && $_REQUEST['project_id']) $whereArray[] = "project_id = '".$objDB->quote($_REQUEST['project_id'])."'";
...
<?php if (!isset($_REQUEST['project_id']) || !is_numeric($_REQUEST['project_id'])) { ?>
<?php echo $pager ?>
<?php } ?>
</div>
