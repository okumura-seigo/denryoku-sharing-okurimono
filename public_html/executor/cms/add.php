...
extract($viewData);
if (isset($REGIST_FORM[$requestData['cms']])) {
	require_once $REGIST_FORM[$requestData['cms']];
	exit;
}
...
<?php } ?>
<form action="add02.php" method="post" enctype="multipart/form-data">
<table>
