...
if (!$requestData['flg']) $requestData['flg'] = array("none", "stop_flg");

// 外部読み込み
if (isset($LIST_VIEW[$requestData['cms']]) && $LIST_VIEW[$requestData['cms']] != "") {
	require_once $LIST_VIEW[$requestData['cms']];
	exit;
}
