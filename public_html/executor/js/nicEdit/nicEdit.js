...
var nicEditorFontFormatSelect = nicEditorSelect.extend({
	sel : {'p' : '段落', 'blockquote' : '引用', 'code' : 'コード', 'pre' : '整形済み', 'h2' : '見出し2', 'h3' : '見出し3', 'h4' : '見出し4'},
	init : function() {
...
var nicCodeButton = nicEditorAdvancedButton.extend({
	...
	addPane : function() {
		this.addForm({
			...
			'code' : {type : 'content', 'value' : this.ne.selectedInstance.getContent(), style : {width: '500px', height : '400px'}}
		});
	},
