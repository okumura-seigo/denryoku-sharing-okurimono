...
<head>
	...
	<title><?php echo (SITE_NAME) ?> システムマネージャー</title>
</head>
...
<div id="main">
	...
	<div id="tray" class="box">
		...
		<p class="f-left box">
			...
			Project: <strong><?php echo (SITE_NAME) ?> システムマネージャー</strong>
...
<!--
		<ul class="box f-right">
			<li><a href="<?php echo (HOME_URL) ?>" target="_blank"><span><strong>Visit Site &raquo;</strong></span></a></li>
		</ul>
-->
		<ul class="box">
	...
	<div id="cols" class="box">
		...
		<div id="aside" class="box">
			...
			<div class="padding box">
				...
				<p id="logo"><a href="<?php echo (HOME_URL) ?>" target="_blank"><img src="../tmp/logo.gif" alt="Our logo" title="Visit Site" /></a></p>
				...
				<p id="btn-create" class="box"><a href="#"><span>ユーザー画面を見る</span></a></p>
			</div> <!-- /padding -->
		...
		<div id="content" class="box">
			...
			<?php foreach ($resCMS as $key => $val) { ?>
			  <tr>
				<td align="center" bgcolor="#FFFFFF"><?php echo escapeHtml($val['system_id']) ?></td>
				<td bgcolor="#FFFFFF"><?php echo escapeHtml($val['system_title']) ?></td>
				<td bgcolor="#FFFFFF"><?php echo escapeHtml($val['system_folder']) ?></td>
				<td bgcolor="#FFFFFF">
					<input type="button" value="一般ページ" onclick="window.open('<?php if ($val['system_folder'] == "") { echo escapeHtml(substr(HOME_URL, 0, (strlen(HOME_URL) - 1)).$val['system_folder']); } else { echo escapeHtml(HOME_URL.$val['system_folder']); } ?>/list.php', 'usr<?php echo escapeHtml($val['system_id']) ?>', 'width=700,height=650,scrollbars=yes,resizable=yes')" />
					<input type="button" value="管理ページ" onclick="window.open('<?php echo escapeHtml(HOME_URL) ?>cms/list.php?cms=<?php echo escapeHtml($val['system_id']) ?>', 'adm<?php echo escapeHtml($val['system_id']) ?>', 'width=700,height=650,scrollbars=yes,resizable=yes')" />
					<input type="button" value="詳細情報" onclick="window.open('<?php echo escapeHtml(HOME_URL) ?>system/detail.php?cms=<?php echo escapeHtml($val['system_id']) ?>', 'cms<?php echo escapeHtml($val['system_id']) ?>', 'width=700,height=650,scrollbars=yes,resizable=yes')" />
				</td>
			  </tr>
			<?php } ?>
			</table>
				...
				<table class="nostyle">
					...
					<tr>
						...
						<td>
							...
							<label><input type="checkbox" /> Lorem ipsum</label> &nbsp;
							<label><input type="checkbox" /> Lorem ipsum</label>						</td>
					</tr>
					<tr>
						<td>Input:</td>
						<td>
							...
							<label><input type="radio" /> Lorem ipsum</label> &nbsp;
							<label><input type="radio" /> Lorem ipsum</label>						</td>
					</tr>
					<tr>
	...
	<div id="footer" class="box">
		...
		<p class="f-right">Templates by <a href="#">Adminizio</a></p>
